...
const AboutMe = (props) => (
    <div>
        <p id="intro"><img className='profile' src={JulieImage} alt='julie' />After a fulfilling career as a science teacher, I have entered the world of technology to pursue a career in web development, with a focus on cryptocurrencies. As our emergent digital economy integrates
